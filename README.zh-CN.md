...
| | |
| ---: | --- |
| **361** | 条活分享，每条链接都在 2026-09-01 实测过——不是从别的列表抄来的 |
| **4** | 条死链隔离进 [`retired.json`](retired.json)，没有继续留在列表里烂着 |
| **361** | 条配有人工写的中文摘要，不是机翻 |
| **361** | 条都标明来自哪个社区目录——其中 348 条还链到最早的原帖 |
| **32** | 条的名字已和官方页对不上，旧名保留在 `aka` 里，依然搜得到 |
