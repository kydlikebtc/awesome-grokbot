...
<h3 align="center">1984 live <code>x.ai/bot</code> shares for Grok Bot.<br>Every link status-checked. Every row attributed to where it came from.</h3>
...
<p align="center">
  ...
  <a href="catalog.json"><img src="https://img.shields.io/badge/live%20shares-1984-blueviolet?style=flat-square" alt="Live shares"></a>
...
<table>
  <tr><td align="right"><b>1984</b></td><td>live shares, every link fetched on 2026-09-24 — not copied from another list</td></tr>
  ...
  <tr><td align="right"><b>1984</b></td><td>rows with a hand-written Chinese summary</td></tr>
  <tr><td align="right"><b>1984</b></td><td>rows naming the catalog they came from — 1094 also link the original post</td></tr>
...
<p align="center">
  ...
  <sub>Instant search over all 1984 rows · eight category filters · EN/中文 · shareable filtered URLs · no build step, no tracking, no cookies</sub>
</p>
...
| Go to | For |
| --- | --- |
| 🌐 [**Browse as a site**](https://kydlikebtc.github.io/awesome-grokbot/) | Search and filter all 1984 rows in the browser |
| 📦 [`catalog.json`](catalog.json) | All 1984 live entries, schema-validated |
...
<table>
  ...
  <tr>
    ...
    <td width="25%" valign="top"><p><strong><a href="docs/category/teams-handoffs.md">🧭 Teams &amp; handoffs</a></strong><br><sub>168 bots</sub></p><sub>Bots that run other bots: rosters, delegation, budgets, and handoffs.</sub><br><br><sub><a href="https://kydlikebtc.github.io/awesome-grokbot/#cat=teams-handoffs">filter on the site ↗</a></sub></td>
  </tr>
</table>
...
| [🧭 Teams & handoffs](docs/category/teams-handoffs.md) | 168 |
| **Total** | **1984** |
...
| Answered under 400 on 2026-09-24 | **1984** |
| Answered 404 across two sweeps → `retired.json` | 6 |
| Rows enriched with first-party `og:` metadata | 1984 |
...
| Rows with a Chinese summary | 1984 / 1984 |
